...
class ServerLogic:
  ...
  def run( self, mojo_dir ):
    ...
    websocket_server = _dojo.SimpleWebSocketServer('', port_websocket, _dojo.websockets.WebSocketHandler)
    websocket_server_process = Process( target = websocket_server.serveforever)
